...
Route::get('estudiantesadmininscripcion',function(){
    $persona=Persona::join('estudiantes','estudiantes.persona_id','=','personas.id')
                    ->select('personas.id','nombre','apellidop','apellidom','foto');
    return datatables()->of($persona)
        ->addColumn('btn','persona.actionadmininscripcion')
        ->rawColumns(['btn','foto'])
        ->toJson();
});
Route::get('estudiantesadminpagos',function(){
    $persona=Persona::join('estudiantes','estudiantes.persona_id','=','personas.id')
                    ->select('personas.id','nombre','apellidop','apellidom','foto');
    return datatables()->of($persona)
        ->addColumn('btn','persona.actionadminpagos')
        ->rawColumns(['btn','foto'])
        ->toJson();
});
Route::get('estudiantesadminreporte',function(){
    $persona=Persona::join('estudiantes','estudiantes.persona_id','=','personas.id')
                    ->select('personas.id','nombre','apellidop','apellidom','foto');
    return datatables()->of($persona)
        ->addColumn('btn','persona.actionadminreporte')
        ->rawColumns(['btn','foto'])
        ->toJson();
});
Route::get('estudiantesadminprogramacion',function(){
    $persona=Persona::join('estudiantes','estudiantes.persona_id','=','personas.id')
                    ->select('personas.id','nombre','apellidop','apellidom','foto');
    return datatables()->of($persona)
        ->addColumn('btn','persona.actionadminprogramacion')
        ->rawColumns(['btn','foto'])
        ->toJson();
});
...
Route::get('personas', function () {
    $persona=Persona::select('id','nombre','apellidop','apellidom','foto')->where('habilitado',1)->get();
    return datatables()->of($persona)
