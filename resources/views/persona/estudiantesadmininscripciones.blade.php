...
@section('content')
    <div class="pt-4">
        <div class="card">
            ...
            <div class="card-body">
                <table id="personasadmininscripcion" class="table table-bordered table-hover table-striped">
...
@section('js')
    ...
    <script src="{{asset('vistas/persona/estudiantesadmininscripcion.js')}}"></script>
@stop