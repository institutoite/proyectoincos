...
Route::get('prueba',[PersonaController::class,'personaSelect2'])->name('prueba');
...
Route::get('/home',[EstudianteController::class,'home'])->name('home');
    ...
    Route::get("personas/select",[PersonaController::class,"personaSelect2"])->name("personas.para.select");
    

    Route::get('adminscripciones', [EstudianteController::class, 'homeadmininscripcion'])->name('homeadmininscripcion');
    Route::get('adminpagos', [EstudianteController::class, 'homeadminpagos'])->name('homeadminpagos');
    Route::get('adminreporte', [EstudianteController::class, 'homeadminreporte'])->name('homeadminreporte');
    Route::get('adminprogramacion', [EstudianteController::class, 'homeadminprogramacion'])->name('homeadminprogramacion');

    Route::get('tus_inscripciones/{estudiante}', 'InscripcioneController@tusinscripciones')->name('tus.inscripciones');
    Route::get('tus_inscripciones/pago/{estudiante}', 'InscripcioneController@tusinscripcionespagos')->name('tus.inscripciones.pagos');
    Route::get('tus_inscripciones/reporte/{estudiante}', 'InscripcioneController@tusinscripcionesreporte')->name('tus.inscripciones.reporte');
    Route::get('tus_inscripciones/programacion/{estudiante}', 'InscripcioneController@tusinscripcionesprogramacion')->name('tus.inscripciones.programacion');
    
    Route::get('tusinscripciones', 'InscripcioneController@tusInscripcionesVigentes')->name('inscripciones.de.estudiante');
    Route::get('tusinscripcionespagos', 'InscripcioneController@tusInscripcionesVigentesPagos')->name('inscripciones.de.estudiante.pagos');
    Route::get('tusinscripcionesreporte', 'InscripcioneController@tusInscripcionesVigentesReporte')->name('inscripciones.de.estudiante.reporte');
    Route::get('tusinscripcionesprogramacion', 'InscripcioneController@tusInscripcionesVigentesProgramacion')->name('inscripciones.de.estudiante.programacion');
    

    Route::get('personas/export/', [PersonaController::class, 'exportarPersonas'])->name("exportar.personas");
    Route::get('programacion/export/{inscripcione}', [ProgramacionController::class, 'exportarProgramacion'])->name('exportar.programacion');
    ...
    Route::get("crear/usuario","UserController@crear")->name("user.create");
    Route::post("store/usuario","UserController@guardar")->name("user.store");
    ...
    Route::delete('eliminar/estudiante/{id}','EstudianteController@eliminarEstudiante')->name('eliminar.estudiante');
    ...
    **/
    ...
    Route::put('role/asignar/permisos/{role}', "RoleController@asignarPermisos")->name('role.asignarpermisos');
    Route::get('role/asignar/permisos/{role}', "RoleController@asignarPermisosForm")->name('role.asignarpermisos.view');
