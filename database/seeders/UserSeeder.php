...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user = new User();
        $user->name = 'Benjamin';
        $user->email = 'benjamin@ite.com.bo';
        $user->persona_id = 11;
        ...
        $user = new User();
        $user->name = 'Wilberth';
        $user->email = 'wilberth@ite.com.bo';
        $user->persona_id = 11;
        $user->password = Hash::make('*Susana25*');
        $user->foto = "estudiantes/susana.jpg";
        $user->save();
