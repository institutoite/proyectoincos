...
@section('content')
    <div class="pt-4">
        <div class="card">
            ...
            <div class="card-body">
                <table id="personasadminprogramacion" class="table table-bordered table-hover table-striped">
...
@section('js')
    ...
    <script src="{{asset('vistas/persona/estudiantesadminprogramacion.js')}}"></script>
@stop