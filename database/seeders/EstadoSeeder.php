...
class EstadoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Estado::create(['estado'=>'PERDIDO']);//12
        ...
        Estado::find(13)->usuarios()->attach(1);
        Estado::find(14)->usuarios()->attach(1);
        Estado::find(15)->usuarios()->attach(1);
        Estado::find(16)->usuarios()->attach(1);
        Estado::find(17)->usuarios()->attach(1);
        Estado::find(18)->usuarios()->attach(1);
        Estado::find(19)->usuarios()->attach(1);
        Estado::find(20)->usuarios()->attach(1);
    }
}
