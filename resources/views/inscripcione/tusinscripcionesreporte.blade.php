    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="inscripcionesVigentesReporte" class="table table-striped table-hover">
                    <thead class="thead">
                        <tr>
                            <th>#</th>
                            <th>Objetivo</th>
    ...
    <script>
     ...
     //%%%%%%%%%%%%%%%%%%%%%%% INICIALIZA EL CKEDITOR CREAR OBSERVACION  %%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        $(document).ready(function() {
            ...
            let tabla=$('#inscripcionesVigentesReporte').DataTable(
                {
                    "serverSide": true,
                    "responsive":true,
                    "autoWidth":false,
                    "ajax":{ 
                        "url":'../../tusinscripcionesreporte',
                        "data":{
