...
class EstudianteController extends Controller
{
    ...
    public function homeadmininscripcion(){

        return view('persona.estudiantesadmininscripciones');

    }
    public function homeadminpagos(){

        return view('persona.estudiantesadminpagos');

    }
    public function homeadminreporte(){

        return view('persona.estudiantesadminreporte');
    }
    public function homeadminprogramacion(){

        return view('persona.estudiantesadminprogramacion');
    }
    ...
    public function eliminarEstudiante($id)
    {
        ...
        $estudiante->delete();
        return response()->json(['mensaje' =>"Registro eliminado correctamente."]); // Retornar una respuesta en formato JSON
    }
