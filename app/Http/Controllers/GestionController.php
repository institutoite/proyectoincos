...
class GestionController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('can:Opciones Docentes')->only("create","store");
        $this->middleware('can:Opciones Computacion')->only("editar","actualizar");
        $this->middleware('can:Opciones Administrativos')->only("destroy");
    }
